<?php
namespace SupportTicket\Test\Fixture;
...
class TicketsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cost' => ['type' => 'decimal', 'length' => 10, 'precision' => 0, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => ''],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => 1,
            'created' => '2017-02-10 15:34:41',
            'modified' => '2017-02-10 15:34:41',
